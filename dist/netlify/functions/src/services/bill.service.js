...
let BillService = BillService_1 = class BillService {
    constructor(billRepository, rewardService) {
        ...
        this.logger = new Logger(BillService_1.name);
    }
    ...
    async findAll() {
        try {
            ...
            throw new InternalServerErrorException(`Failed to fetch bills: ${error.message}`);
        }
    }
    async findByUserId(userId) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to fetch bills for user: ${error.message}`);
        }
    }
    async findOne(id) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to fetch bill: ${error.message}`);
        }
    }
    async payBill(id, payBillDto) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to process bill payment: ${error.message}`);
        }
    }
    ...
    async getRecentBillsByUser(userId, limit = 3) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to fetch recent bills: ${error.message}`);
        }
    }
    async getUnpaidBillsByUser(userId) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to fetch unpaid bills: ${error.message}`);
        }
    }
    async update(id, updateBillDto) {
        try {
            ...
            throw new InternalServerErrorException(`Failed to update bill: ${error.message}`);
        }
    }
};
BillService = BillService_1 = __decorate([
    Injectable(),
    __param(0, Inject("BILL_REPOSITORY")),
    __metadata("design:paramtypes", [Object, RewardService])
], BillService);
export { BillService };
