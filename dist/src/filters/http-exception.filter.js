...
let HttpExceptionFilter = HttpExceptionFilter_1 = class HttpExceptionFilter {
    constructor() {
        ...
        const error = typeof exceptionResponse === "string"
            ...
            : exceptionResponse;
        const errorResponse = Object.assign({ statusCode: status, timestamp: new Date().toISOString(), path: request.url, method: request.method }, error);
        this.logger.error(`HTTP ${status} Error: ${request.method} ${request.url}`, JSON.stringify(errorResponse, null, 2));
